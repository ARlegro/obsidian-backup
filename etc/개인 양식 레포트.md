...
**시도 1. MultiPart Upload 방식 구현 시도**
...
시도 2. 로컬 저장 후 S3 전송 + MultiResourceItemReader
- 흐름
...
✅하지만, 파일 수 증가라는 단점보다, 배치 구조 단순화 및 개발일정 준수라는 장점이 더 크다고 판단했습니다,
...
**6‍⃣ 배치에서 step끼리 자원 공유 리팩토링 - PromotionListener**
